...
explicit support for sharing common subexpressions.  You'll recall from [one of my previous posts](/sharing-in-haskell-edsls) that we
...
With an appropriate [graph evaluator](sharing-in-haskell-edsls)
